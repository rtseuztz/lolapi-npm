...
describe('e2e DUMMY TEST', () => {
    const client = new RiotAPIClient(process.env.API_KEY!, 750, 10);
    describe('summoner', () => {
        ...
        it('should get a summoner by puuid', async () => {
            const summoner = await client.summoner.getByPuuid("OwgyIL6OJu9MS_u09y_tQzAZPNmXI2SkQWhqOV44pFah2Jrs4rsFg8LFLGpgDQCaY1hLylhNCvqb9w");
            expect(summoner.name).toBe("R i o t T e s t");
    ...
    describe('match', () => {
        ...
        //     const matchList: string[] = await client.match.getMatchList("GZvRP1eq90bmEpWYc6wMKzFKgIFGbzT5NcREHAIxJ56hwFbZYDmhOcpMKaTszZL5278fwHyjh9UsXg");
